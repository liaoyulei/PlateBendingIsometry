...
for k = 1: Nt
    ...
    for l = 1: size(wg, 1)
        vxx = phixx(ld(l, 1), ld(l, 2), ld(l, 3), v1(1), v2(1), v3(1), v1(2), v2(2), v3(2));
        vxy = phixy(ld(l, 1), ld(l, 2), ld(l, 3), v1(1), v2(1), v3(1), v1(2), v2(2), v3(2));
        vyy = phiyy(ld(l, 1), ld(l, 2), ld(l, 3), v1(1), v2(1), v3(1), v1(2), v2(2), v3(2));
        for j = 1: size(mesh, 2)
            for i = 1: size(mesh, 2)
...
for k = 1: Nt
    ...
    jacobi = T(v1(1), v2(1), v3(1), v1(2), v2(2), v3(2));
    for l = 1: size(wg, 1)
        v = phi(ld(l, 1), ld(l, 2), ld(l, 3), v1(1), v2(1), v3(1), v1(2), v2(2), v3(2));
